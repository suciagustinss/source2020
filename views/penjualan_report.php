            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">Kode Barang</th><th>Nama Barang</th><th>Merek</th><th>Jenis Barang</th><th>Tanggal Jual</th><th>Jumlah</th><th>Harga</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['harga'] ?></td>
                                    <td>
                                        <a href="report/penjualan_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
                            ...
                            <tr>
                                <td colspan="9">
                                    ...
                                    <a href="#cetak_perbulan" class="btn btn-info btn-sm">
                                        <span class="fa fa_print"></span> Cetak Penjualan Perbulan 

                                    </a>
                                    <a href="#cetak_pertahun" class="btn btn-info btn-sm">
                                        <span class="fa fa_print"></span> Cetak Perbulan Pertahun 
