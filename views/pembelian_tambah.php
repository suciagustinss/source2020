                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            <label for="nama_pembeli" class="col-sm-3 control-label">Nama Pembeli</label>
                             <div class="col-sm-9">
                                <input type="text" name="nama_pembeli" vclass="form-control" id="inputEmail3" placeholder="Nama Pembeli" readonly="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="kode_barang" class="col-sm-3 control-label">Kode Barang</label>
                             <div class="col-sm-9">
                                <input type="text" name="kode_barang" class="form-control" id="inputEmail3" placeholder="Kode Barang" readonly="true">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-edit"></span> Simpan Data Pembelian</button>
                            </div>
                        </div>
                    </form>
