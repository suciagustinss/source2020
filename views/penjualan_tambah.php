                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nama_barang"  class="form-control" id="inputPassword3" placeholder="nama_barang">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="merek" class="col-sm-3 control-label">Merek Barang</label>
                            <div class="col-sm-9">
                                <input type="text" name="merek" class="form-control" id="inputEmail3" placeholder="Merek Barang">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="jenis Barang" class="col-sm-3 control-label">Jenis Barang</label>
                            <div class="col-sm-9">
                                <input type="text" name="jenis_barang" class="form-control" id="inputEmail3" placeholder="Jenis Barang">
                            </div>
                        </div>
                        ...
                        <br><div class="form-group">Jumlah</label>
                            <div class="col-sm-9">
                                <input type="text" name="jumlah" class="form-control" id="inputPassword3" placeholder="Jumlah">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Harga" class="col-sm-3 control-label">Harga</label>
                            <div class="col-sm-9">
                                <input type="text" name="Harga"  class="form-control" id="inputPassword3" placeholder="Harga">
                            </div>
                        </div>
                        <!--Status-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="keterangan"  class="form-control" id="inputPassword3" placeholder="Keterangan">
                            </div>
                        </div>
                        <div class="form-group">
